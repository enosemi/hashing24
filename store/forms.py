...
class AddressForm(forms.ModelForm):
    class Meta:
        model = Address
        fields = ['Duration', 'Amount', 'Email']
        widgets = {'Duration':forms.TextInput(attrs={'class':'form-control', }), 'Amount':forms.TextInput(attrs={'class':'form-control', }), 'Email':forms.TextInput(attrs={'class':'form-control', })}
